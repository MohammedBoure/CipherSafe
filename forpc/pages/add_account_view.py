...
def colm2_container1_colm(page):
    ...
    if shared.data_account:
        ...
        return ft.Column(
            controls=[
                ft.Container(
                    content=ft.Text(f"إنشاء خانة {shared.name_account}", size=font_size["title"], weight=ft.FontWeight.BOLD, rtl=True),
                    alignment=ft.alignment.center,
                    padding=ft.padding.symmetric(vertical=15),
                ),
                ft.Container(
...
#for encrypted file
    ...
    colm1 = ft.Row(controls=[colm2_container1, colm2_container2], expand=15)
